...
class BookmarkAdapter:RecyclerView.Adapter<BookmarkAdapter.NewsViewHolder>() {
    ...
    private var data:List<BookmarkNewsItem> = mutableListOf()
    ...
    fun setData(data:List<BookmarkNewsItem>) {
        this.data = data
        notifyDataSetChanged()
    }

    fun getData(): List<BookmarkNewsItem>{
        return data
    }

    fun getItem(position:Int):BookmarkNewsItem {
