...
import com.example.shortnews.model.Search_NewsItem
...
class SearchAdapter:RecyclerView.Adapter<SearchAdapter.NewsViewHolder>() {
    ...
    private var data:MutableList<Search_NewsItem> = mutableListOf()
    ...
    fun setData(data:MutableList<Search_NewsItem>) {
        this.data = data
        notifyDataSetChanged()
    }

    fun getItem(position:Int): Search_NewsItem {
