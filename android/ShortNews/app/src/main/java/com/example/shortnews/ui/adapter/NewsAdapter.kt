...
class NewsAdapter:RecyclerView.Adapter<NewsAdapter.NewsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NewsViewHolder, position: Int) {
        ...
        if(item.report > 0) holder.newsBlindCardView.visibility = VISIBLE
        else holder.newsBlindCardView.visibility = GONE
    }
    ...
    class NewsViewHolder(view: View, listener: OnItemClickListener?, bookmarkClickListener: OnBookmarkClickListener?): RecyclerView.ViewHolder(view){
        ...
        var newsBlindCardView:CardView = view.findViewById(R.id.newsBlindCardView)
        ...
        init {
            ...
            newsBlindCardView.setOnSingleClickListener {
                newsBlindCardView.visibility = GONE
            }
        }
    }
